...
import com.qworks.workflow.dto.LanePoolReferencePoints;
import com.qworks.workflow.dto.SequenceReferencePoints;
...
public class BPMNDiagramGenerator {
    ...
    public static File generateBPMNDiagram(File file) {
        try {
            ...
            File outputFile = File.createTempFile("bpmn_diagram", ".bpmn");
