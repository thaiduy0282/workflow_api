...
public class ProcessHistoryServiceImpl implements ProcessHistoryService {
    ...
    @Override
    @Transactional
    public ProcessHistoryDto update(String activityId, UpdateProcessHistoryRequest request) {
        ...
        request.description().ifPresent(processHistoryEntity::setDescription);
